  ...
  return (
    <Container className='Product-search'>
        <Row className='gap-1 justify-content-md-center mb-1'>
          <Col xs={2} className='bg-success p-1'>Hae tuotteita</Col>
          <Col xs={6} className='bg-success p-1'>
            <Form.Control variant="light" type="text" placeholder="Etsi tuotetta"/>
          </Col>
          <Col xs={1} className='bg-success p-1'> <Button ><Link to={"/results"}>Hae</Link></Button>   </Col>
        </Row>
        <Row className='gap-1 justify-content-md-center'>
            <Col xs={3} className='bg-success'>Kategoria
            <hr></hr>
              <Dropdown>
            ...
            <Col xs={3} className='bg-success'>Maakunta
              <hr></hr>
              <Dropdown style={{minWidth:"100%"}} >
                <Dropdown.Toggle variant="light" id="dropdown-basic2" style={{minWidth:"100%"}}>
                  Maakunta
                </Dropdown.Toggle>
                <Dropdown.Menu style={{maxHeight:"200px", overflowY:"auto"}}>
                  ...
                  <Dropdown.Item href="#/action-14">Pohjois-Pohjanmaa</Dropdown.Item>
            ...
            <Col xs={3} className='bg-success'>Hinta
            <hr></hr>
            <Form>
